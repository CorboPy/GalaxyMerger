# N_body_Single_Cython.py is serial Cython.
# How to use:
#   - Adjust simulation parameters (timestep, num_steps, etc) defined at the start of main()
#   - If want to relax a single galaxy with initial conditions in GalaxyMerger/, run without an argument. E.g. python N_body_Single_Cython.py
#   - If want to simualte galaxy merger, run with "../initial_galaxy_N" as an argument. E.g. for N=2000 merger: python N_body_Single_Cython.py ../initial_galaxy_2000
